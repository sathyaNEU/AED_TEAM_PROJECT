...
public class CourseRegisterJPanel extends javax.swing.JPanel {
    ...
    private void populateTable() {
        DefaultTableModel dtm = (DefaultTableModel) tblCourseSchedule.getModel();
        dtm.setRowCount(0);
        for (CourseTimeSchedule courseTime : course.getCourseTimeScheduleList()) {
            Object[] row = new Object[2];
            row[0] = courseTime;
            row[1] = courseTime.getTiming();
            dtm.addRow(row);
    ...
    private void initComponents() {
        ...
        if (tblCourseSchedule.getColumnModel().getColumnCount() > 0) {
            tblCourseSchedule.getColumnModel().getColumn(0).setResizable(false);
            tblCourseSchedule.getColumnModel().getColumn(1).setResizable(false);
        }

        jLabel10.setText("Schedule Timing");
